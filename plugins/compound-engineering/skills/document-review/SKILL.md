...
**If no document is specified (headless mode):** Output "Review failed: headless mode requires a document path. Re-invoke the document-review skill with argument: mode:headless <path>" without dispatching agents.
